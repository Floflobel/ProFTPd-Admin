        ...
        <div class="col-sm-12">
          <form role="form" class="form-horizontal" method="post" data-toggle="validator">
            ...
            <div class="form-group">
              ...
              <div class="controls col-sm-8">
                <input type="text" class="form-control" id="<?php echo $field_homedir; ?>" name="<?php echo $field_homedir; ?>" value="" placeholder="Enter a home folder" pattern="<?php echo substr($cfg['homedir_regex']); ?>" required />
              </div>
            </div>
            <!-- Real name -->
            <div class="form-group">
